...
# 2013-11-05 21:16:18.330233. Think long and hard before
...
class IImpactBioDiversityState(Parameters):
    biodiv = IVariable1Dimensional(
        'biodiv', ['Timestep'], 'double', 'Change in number of species in relation to the year 2000')
    species = IVariable2Dimensional(
