...
# 2013-05-31 13:51:00.552717. Think long and hard before
...
class IImpactAggregationState(Parameters):
    ...
    options = [eloss, sloss, loss, income, water,
               forests, heating, cooling, agcost, drycost, protcost, entercost, hurrdam, extratropicalstormsdam, species, deadcost, morbcost, wetcost, leavecost]
