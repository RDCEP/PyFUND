...
# 2013-10-25 13:47:57.799481. Think long and hard before
...
class IImpactAggregationState(Parameters):
    ...
    hurrdam = IParameter2Dimensional(
        'hurrdam', ['Timestep', 'Region'], 'double', None)
    ...
    species = IParameter2Dimensional(
        'species', ['Timestep', 'Region'], 'double', None)
    deadcost = IParameter2Dimensional(
        'deadcost', ['Timestep', 'Region'], 'double', None)
    morbcost = IParameter2Dimensional(
        'morbcost', ['Timestep', 'Region'], 'double', None)
