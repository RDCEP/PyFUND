...
# 2013-05-31 17:48:41.928939. Think long and hard before
...
class IImpactAggregationState(Parameters):
    eloss = IVariable2Dimensional('eloss', [
                                  'Timestep', 'Region'], 'double', None)
    sloss = IVariable2Dimensional('sloss', [
                                  'Timestep', 'Region'], 'double', None)
    loss = IVariable2Dimensional('loss', [
                                 'Timestep', 'Region'], 'double', None)
    income = IParameter2Dimensional('income', [
                                    'Timestep', 'Region'], 'double', None)
    water = IParameter2Dimensional('water', [
                                   'Timestep', 'Region'], 'double', None)
    forests = IParameter2Dimensional('forests', [
                                     'Timestep', 'Region'], 'double', None)
    heating = IParameter2Dimensional('heating', [
                                     'Timestep', 'Region'], 'double', None)
    cooling = IParameter2Dimensional('cooling', [
                                     'Timestep', 'Region'], 'double', None)
    agcost = IParameter2Dimensional('agcost', [
                                    'Timestep', 'Region'], 'double', None)
    drycost = IParameter2Dimensional('drycost', [
                                     'Timestep', 'Region'], 'double', None)
    protcost = IParameter2Dimensional('protcost', [
                                      'Timestep', 'Region'], 'double', None)
    entercost = IParameter2Dimensional('entercost', [
                                       'Timestep', 'Region'], 'double', None)
    hurrdam = IParameter2Dimensional('hurrdam', [
                                     'Timestep', 'Region'], 'double', None)
    extratropicalstormsdam = IParameter2Dimensional(
        'extratropicalstormsdam', ['Timestep', 'Region'], 'double', None)
    species = IParameter2Dimensional('species', [
                                     'Timestep', 'Region'], 'double', None)
    deadcost = IParameter2Dimensional('deadcost', [
                                      'Timestep', 'Region'], 'double', None)
    morbcost = IParameter2Dimensional('morbcost', [
                                      'Timestep', 'Region'], 'double', None)
    wetcost = IParameter2Dimensional('wetcost', [
                                     'Timestep', 'Region'], 'double', None)
    leavecost = IParameter2Dimensional('leavecost', [
                                       'Timestep', 'Region'], 'double', None)
    ...
    switchoffextratropicalstormsdam = ScalarVariable(
        'switchoffextratropicalstormsdam', 'Boolean', None)
    ...
    options = [
        eloss, sloss, loss, income, water, forests, heating, cooling, agcost, drycost, protcost, entercost, hurrdam, extratropicalstormsdam, species, deadcost, morbcost, wetcost, leavecost, switchoffwater, switchoffforests, switchoffheating,
        switchoffcooling, switchoffagcost, switchoffdrycost, switchoffprotcost, switchoffentercost, switchoffhurrdam, switchoffextratropicalstormsdam, switchoffspecies, switchoffdeadcost, switchoffmorbcost, switchoffwetcost, switchoffleavecost]
