...
# 2013-05-31 13:51:11.001305. Think long and hard before
...
class IPopulationState(Parameters):
    ...
    options = [population, populationin1,
               globalpopulation, pgrowth, enter, leave, dead, pop0]
        ...
        if (clock.IsFirstclock):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.population[t, r] = ((1.0 + 0.01 * s.pgrowth[t - 1, r]) * (s.population[t - 1, r] +
                                                                            (
                                                                            (t >= clock.FromSimulationYear(40)) and not s.runwithoutpopulationperturbation and (s.enter[t - 1, r] / 1000000.0) - (
