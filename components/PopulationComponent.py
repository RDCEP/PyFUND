...
# 2013-11-05 21:16:26.646071. Think long and hard before
                ...
                s.population[t, r] = ((1.0 + 0.01 * s.pgrowth[t - 1, r]) * (s.population[t - 1, r] +
                                                                            (
                                                                                (t >= Timestep.FromSimulationYear(40)) and not s.runwithoutpopulationperturbation and (
                                                                                    s.enter[t - 1, r] / 1000000.0) - (s.leave[t - 1, r] / 1000000.0) - (s.dead[t - 1, r] >= 0 and s.dead[t - 1, r] / 1000000.0 or 0) or 0
                                                                            )
                                                                            ))
