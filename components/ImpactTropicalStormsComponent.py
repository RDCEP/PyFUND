...
# 2013-05-31 17:48:50.972082. Think long and hard before
...
class IImpactTropicalStormsState(Parameters):
    hurrdam = IVariable2Dimensional('hurrdam', [
                                    'Timestep', 'Region'], 'double', None)
    hurrdead = IVariable2Dimensional('hurrdead', [
                                     'Timestep', 'Region'], 'double', None)
    hurrbasedam = IParameter1Dimensional(
        'hurrbasedam', ['Region'], 'double', None)
    hurrbasedead = IParameter1Dimensional(
        'hurrbasedead', ['Region'], 'double', None)
    ...
    income = IParameter2Dimensional('income', [
                                    'Timestep', 'Region'], 'double', None)
    regstmp = IParameter2Dimensional('regstmp', [
                                     'Timestep', 'Region'], 'double', None)
    ...
    options = [hurrdam, hurrdead, hurrbasedam, hurrbasedead, gdp90, pop90,
               population, income, regstmp, hurrdamel, hurrnl, hurrpar, hurrdeadel]
