...
class IImpactTropicalStormsState(Parameters):
    hurrdam = IVariable2Dimensional('hurrdam', ['Timestep', 'Region'], 'double', None)
    hurrdead = IVariable2Dimensional('hurrdead', ['Timestep', 'Region'], 'double', None)
    hurrbasedam = IParameter1Dimensional('hurrbasedam',['Region'],'double',None)
    hurrbasedead = IParameter1Dimensional('hurrbasedead',['Region'],'double',None)
    ...
    regstmp = IParameter2Dimensional('regstmp', ['Timestep', 'Region'], 'double', None)
...
class ImpactTropicalStormsComponent(Behaviors):
    ...
    def run(self, state, clock, dimensions):
        ...
        for r in dimensions.GetValuesOfRegion():
            ...
            s.hurrdam[t, r] = (0.001 * s.hurrbasedam[r] * s.income[t, r] * math.pow(ypc / ypc90, s.hurrdamel) *
                               (math.pow(1.0 + s.hurrpar * s.regstmp[t, r], s.hurrnl) - 1.0))

            s.hurrdead[t, r] = (1000.0 * s.hurrbasedead[r] * s.population[t,r] * math.pow(ypc /ypc90,s.hurrdeadel) *
                                (math.pow(1.0 + s.hurrpar * s.regstmp[t, r], s.hurrnl) - 1.0))
