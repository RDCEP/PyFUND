...
class IImpactCardiovascularRespiratoryState(Parameters):
    basecardvasc = IVariable2Dimensional('basecardvasc', ['Timestep', 'Region'], 'double', None)
    baseresp = IVariable2Dimensional('baseresp', ['Timestep', 'Region'], 'double', None)
    cardheat = IVariable2Dimensional('cardheat', ['Timestep', 'Region'], 'double', None)
    resp = IVariable2Dimensional('resp', ['Timestep', 'Region'], 'double', None)
    cardcold = IVariable2Dimensional('cardcold', ['Timestep', 'Region'], 'double', None)
    cardvasc90 = IParameter1Dimensional('cardvasc90',['Region'],'double', None)
    ...
    plus = IParameter2Dimensional('plus', ['Timestep', 'Region'], 'double', None)
    temp = IParameter2Dimensional('temp', ['Timestep', 'Region'], 'double', None)
    urbpop = IParameter2Dimensional('urbpop', ['Timestep', 'Region'], 'double', None)
