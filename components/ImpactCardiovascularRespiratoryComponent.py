...
# 2013-10-25 13:47:59.902395. Think long and hard before
...
class IImpactCardiovascularRespiratoryState(Parameters):
    basecardvasc = IVariable2Dimensional(
        'basecardvasc', ['Timestep', 'Region'], 'double', None)
    baseresp = IVariable2Dimensional(
        'baseresp', ['Timestep', 'Region'], 'double', None)
    cardheat = IVariable2Dimensional(
        'cardheat', ['Timestep', 'Region'], 'double', None)
    resp = IVariable2Dimensional(
        'resp', ['Timestep', 'Region'], 'double', None)
    cardcold = IVariable2Dimensional(
        'cardcold', ['Timestep', 'Region'], 'double', None)
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.cardheat[t, r] = (
                    s.cardheat[t, r] * s.urbpop[t, r] * s.population[t, r] * 10)
                ...
                s.resp[t, r] = (
                    s.rlbm[r] * s.temp[t, r] + s.rqbm[r] * math.pow(s.temp[t, r], 2))
                s.resp[t, r] = (
                    s.resp[t, r] * s.urbpop[t, r] * s.population[t, r] * 10)
                ...
                if (s.cardcold[t, r] < -1000 * s.maxcardvasc * s.basecardvasc[t, r] * s.population[t, r]):
                    s.cardcold[t, r] = (
                        -1000 * s.maxcardvasc * s.basecardvasc[t, r] * s.population[t, r])
                if (s.cardcold[t, r] > 0):
                    s.cardcold[t, r] = (0)
