...
# 2013-05-31 13:51:02.911600. Think long and hard before
...
class IImpactCardiovascularRespiratoryState(Parameters):
    ...
    options = [
        basecardvasc, baseresp, cardheat, resp, cardcold, cardvasc90, plus90, resp90, chplbm,
        chmlbm, chpqbm, chmqbm, rlbm, rqbm, ccplbm, ccmlbm, ccpqbm, ccmqbm, plus, temp, urbpop, population]
