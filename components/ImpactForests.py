...
class IImpactForestsState(Parameters):
    forests = IVariable2Dimensional('forests', ['Timestep', 'Region'], 'double', None)
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.forests[t, r] = (s.forbm[r] * s.income[t,r] * math.pow(ypc / ypc90, s.forel) * (0.5 *
                                    math.pow(s.temp[t,r], s.fornl) + 0.5 * math.log(s.acco2[t-1] /
                                    s.co2pre) * s.forco2))
