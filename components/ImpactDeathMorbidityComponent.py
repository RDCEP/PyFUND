...
class IImpactDeathMorbidityState(Parameters):
    dead = IVariable2Dimensional('dead', ['Timestep', 'Region'], 'double', None)
    yll = IVariable2Dimensional('yll', ['Timestep', 'Region'], 'double', None)
    yld = IVariable2Dimensional('yld', ['Timestep', 'Region'], 'double', None)
    deadcost = IVariable2Dimensional('deadcost', ['Timestep', 'Region'], 'double', None)
    morbcost = IVariable2Dimensional('morbcost', ['Timestep', 'Region'], 'double', None)
    vsl = IVariable2Dimensional('vsl', ['Timestep', 'Region'], 'double', None)
    vmorb = IVariable2Dimensional('vmorb', ['Timestep', 'Region'], 'double', None)
    ...
    dengue = IParameter2Dimensional('dengue', ['Timestep', 'Region'], 'double', None)
    schisto = IParameter2Dimensional('schisto', ['Timestep', 'Region'], 'double', None)
    malaria = IParameter2Dimensional('malaria', ['Timestep', 'Region'], 'double', None)
    cardheat = IParameter2Dimensional('cardheat', ['Timestep', 'Region'], 'double', None)
    cardcold = IParameter2Dimensional('cardcold', ['Timestep', 'Region'], 'double', None)
    resp = IParameter2Dimensional('resp', ['Timestep', 'Region'], 'double', None)
    diadead = IParameter2Dimensional('diadead', ['Timestep', 'Region'], 'double', None)
    hurrdead = IParameter2Dimensional('hurrdead', ['Timestep', 'Region'], 'double', None)
    extratropicalstormsdead = IParameter2Dimensional('extratropicalstormsdead', ['Timestep', 'Region'], 'double', None)
    population = IParameter2Dimensional('population', ['Timestep', 'Region'], 'double', None)
    diasick = IParameter2Dimensional('diasick', ['Timestep', 'Region'], 'double', None)
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.yll[t,r] = (s.d2ld[r] * s.dengue[t,r] + s.d2ls[r] * s.schisto[t,r] +
                                s.d2lm[r] * s.malaria[t,r] + s.d2lc[r] * s.cardheat[t,r] +
                                s.d2lc[r] * s.cardcold[t,r] + s.d2lr[r] * s.resp[t,r])

                s.yld[t, r] = (s.d2dd[r] * s.dengue[t, r] + s.d2ds[r] * s.schisto[t, r] + s.d2dm[r] *
                               s.malaria[t, r] + s.d2dc[r] * s.cardheat[t, r] + s.d2dc[r] * s.cardcold[t, r] +
                               s.d2dr[r] * s.resp[t, r] + s.diasick[t, r])
