...
# 2013-11-05 21:16:20.175765. Think long and hard before
...
class IImpactDeathMorbidityState(Parameters):
    dead = IVariable2Dimensional(
        'dead', ['Timestep', 'Region'], 'double', None)
    ...
    vmorb = IVariable2Dimensional(
        'vmorb', ['Timestep', 'Region'], 'double', None)
    ...
    dengue = IParameter2Dimensional(
        'dengue', ['Timestep', 'Region'], 'double', None)
    schisto = IParameter2Dimensional(
        'schisto', ['Timestep', 'Region'], 'double', None)
    malaria = IParameter2Dimensional(
        'malaria', ['Timestep', 'Region'], 'double', None)
    ...
    diadead = IParameter2Dimensional(
        'diadead', ['Timestep', 'Region'], 'double', None)
    hurrdead = IParameter2Dimensional(
        'hurrdead', ['Timestep', 'Region'], 'double', None)
    ...
    diasick = IParameter2Dimensional(
        'diasick', ['Timestep', 'Region'], 'double', None)
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.vmorb[t, r] = (
                    s.vmorbbm * math.pow(ypc / s.vmorbypc0, s.vmorbel))
