...
# 2013-05-31 13:51:04.362731. Think long and hard before
...
class IImpactDeathMorbidityState(Parameters):
    ...
    options = [
        dead, yll, yld, deadcost, morbcost, vsl, vmorb, d2ld, d2ls, d2lm, d2lc, d2lr, d2dd, d2ds, d2dm, d2dc, d2dr,
        dengue, schisto, malaria, cardheat, cardcold, resp, diadead, hurrdead, extratropicalstormsdead, population, diasick, income]
