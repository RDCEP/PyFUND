...
# 2013-05-31 13:51:06.550263. Think long and hard before
...
class IImpactSeaLevelRiseState(Parameters):
    wetval = IVariable2Dimensional('wetval', [
                                   'Timestep', 'Region'], 'double', None)
    wetlandloss = IVariable2Dimensional('wetlandloss', [
                                        'Timestep', 'Region'], 'double', None)
    ...
    wetcost = IVariable2Dimensional('wetcost', [
                                    'Timestep', 'Region'], 'double', None)
    dryval = IVariable2Dimensional('dryval', [
                                   'Timestep', 'Region'], 'double', None)
    landloss = IVariable2Dimensional('landloss', [
                                     'Timestep', 'Region'], 'double', None)
    cumlandloss = IVariable2Dimensional('cumlandloss', [
                                        'Timestep', 'Region'], 'double', None)
    drycost = IVariable2Dimensional('drycost', [
                                    'Timestep', 'Region'], 'double', None)
    npprotcost = IVariable2Dimensional('npprotcost', [
                                       'Timestep', 'Region'], 'double', None)
    npwetcost = IVariable2Dimensional('npwetcost', [
                                      'Timestep', 'Region'], 'double', None)
    npdrycost = IVariable2Dimensional('npdrycost', [
                                      'Timestep', 'Region'], 'double', None)
    protlev = IVariable2Dimensional('protlev', [
                                    'Timestep', 'Region'], 'double', None)
    protcost = IVariable2Dimensional('protcost', [
                                     'Timestep', 'Region'], 'double', None)
    enter = IVariable2Dimensional('enter', [
                                  'Timestep', 'Region'], 'double', None)
    leave = IVariable2Dimensional('leave', [
                                  'Timestep', 'Region'], 'double', None)
    entercost = IVariable2Dimensional('entercost', [
                                      'Timestep', 'Region'], 'double', None)
    leavecost = IVariable2Dimensional('leavecost', [
                                      'Timestep', 'Region'], 'double', None)
    imigrate = IVariable2Dimensional('imigrate', [
    ...
    migrate = IParameter2Dimensional('migrate', [
                                     'Region', 'Region'], 'double', None)
    income = IParameter2Dimensional('income', [
                                    'Timestep', 'Region'], 'double', None)
    population = IParameter2Dimensional('population', [
                                        'Timestep', 'Region'], 'double', None)
    area = IParameter2Dimensional('area', [
                                  'Timestep', 'Region'], 'double', None)

    options = [
        wetval, wetlandloss, cumwetlandloss, wetlandgrowth, wetcost, dryval, landloss, cumlandloss, drycost, npprotcost, npwetcost, npdrycost, protlev, protcost, enter,
        leave, entercost, leavecost, imigrate, pc, slrprtp, wmbm, dlbm, drylandlossparam, wlbm, coastpd, wetmax, wetland90, maxlandloss, sea, migrate, income, population, area]
