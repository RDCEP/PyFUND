...
# 2013-05-31 15:40:41.907520. Think long and hard before
...
class IImpactVectorBorneDiseasesState(Parameters):
    dengue = IVariable2Dimensional('dengue', [
                                   'Timestep', 'Region'], 'double', None)
    schisto = IVariable2Dimensional('schisto', [
                                    'Timestep', 'Region'], 'double', None)
    malaria = IVariable2Dimensional('malaria', [
                                    'Timestep', 'Region'], 'double', None)
