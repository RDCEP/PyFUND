...
# 2013-10-25 13:48:06.307267. Think long and hard before
...
class IImpactVectorBorneDiseasesState(Parameters):
    ...
    options = [dengue, schisto, malaria, dfbs, dfch, smbs, smch, malbs,
               malch, gdp90, pop90, income, population, temp, dfnl, vbel, smnl, malnl]
    ...
    def run(self, state, clock, dimensions):
        ...
        for r in dimensions.GetValuesOfRegion():
            ...
            if (s.schisto[t, r] < -s.smbs[r] * s.population[t, r] * math.pow(ypc / ypc90, s.vbel)):
                s.schisto[t, r] = (
                    -s.smbs[r] * s.population[t, r] * math.pow(ypc / ypc90, s.vbel))
