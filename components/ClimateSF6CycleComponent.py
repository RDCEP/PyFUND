...
class IClimateSF6CycleState(Parameters):
    globsf6 = IParameter1Dimensional('globsf6',['Timestep'],'double','Global SF6 emissions in kt of SF6')
    acsf6 = IVariable1Dimensional('acsf6',['Timestep'],'double','Atmospheric SF6 concentrations')
