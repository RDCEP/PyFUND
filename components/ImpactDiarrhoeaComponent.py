...
# 2013-10-25 13:48:02.163053. Think long and hard before
...
class IImpactDiarrhoeaState(Parameters):
    diadead = IVariable2Dimensional(
        'diadead', ['Timestep', 'Region'], 'Double', None)
    diasick = IVariable2Dimensional(
    ...
    regtmp = IParameter2Dimensional(
        'regtmp', ['Timestep', 'Region'], 'Double', None)
