...
# 2013-05-31 13:50:55.631119. Think long and hard before
...
class IEmissionsState(Parameters):
    ...
    options = [
        mitigationcost, ch4cost, ch4costindollar, n2ocost, ryg, energint, emissint, emission, emissionwithforestry, so2WithSeeiAndScei, so2, sf6, reei, rcei, energuse, seei, scei, ch4, n2o, n2ored, taxpar, co2red, know, perm, cumaeei, ch4red, minint, globknow, mco2, globch4,
        globn2o, globsf6, globso2, cumglobco2, cumglobch4, cumglobn2o, cumglobsf6, cumglobso2, taxmp, sf60, GDP90, pop90, ch4par1, ch4par2, n2opar1, n2opar2, gdp0, emissint0, so20, forestemm, aeei, acei, ch4em, n2oem, currtax, currtaxch4, currtaxn2o, pgrowth, ypcgrowth, income, population]
        ...
        if (clock.IsFirstclock):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.sf6[t, r] = ((s.sf60[r] + s.sf6gdp * (s.income[t, r] - s.GDP90[r]) + s.sf6ypc * (s.income[t - 1, r] / s.population[t - 1, r] - s.GDP90[r] / s.pop90[r])) * (
                    t <= clock.FromSimulationYear(60) and 1 + (t.Value - 40.0) / 40.0 or 1.0 + (60.0 - 40.0) / 40.0) * (t > clock.FromSimulationYear(60) and math.pow(0.99, t.Value - 60.0) or 1.0))
