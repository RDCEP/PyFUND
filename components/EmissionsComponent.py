...
class IEmissionsState(Parameters):
    mitigationcost = IVariable2Dimensional('mitigationcost', ['Timestep', 'Region'], 'double', None)
    ch4cost = IVariable2Dimensional('ch4cost', ['Timestep', 'Region'], 'double', None)
    ch4costindollar = IVariable2Dimensional('ch4costindollar', ['Timestep', 'Region'], 'double', None)
    n2ocost = IVariable2Dimensional('n2ocost', ['Timestep', 'Region'], 'double', None)
    ryg = IVariable2Dimensional('ryg', ['Timestep', 'Region'], 'double', None)
    energint = IVariable2Dimensional('energint', ['Timestep', 'Region'], 'double', None)
    emissint = IVariable2Dimensional('emissint', ['Timestep', 'Region'], 'double', None)
    emission = IVariable2Dimensional('emission', ['Timestep', 'Region'], 'double', None)
    emissionwithforestry = IVariable2Dimensional('emissionwithforestry', ['Timestep', 'Region'], 'double', None)
    so2WithSeeiAndScei = IVariable2Dimensional('so2WithSeeiAndScei', ['Timestep', 'Region'], 'double', None)
    so2 = IVariable2Dimensional('so2', ['Timestep', 'Region'], 'double', None)
    sf6 = IVariable2Dimensional('sf6', ['Timestep', 'Region'], 'double', None)
    reei = IVariable2Dimensional('reei', ['Timestep', 'Region'], 'double', None)
    rcei = IVariable2Dimensional('rcei', ['Timestep', 'Region'], 'double', None)
    energuse = IVariable2Dimensional('energuse', ['Timestep', 'Region'], 'double', None)
    seei = IVariable2Dimensional('seei', ['Timestep', 'Region'], 'double', None)
    scei = IVariable2Dimensional('scei', ['Timestep', 'Region'], 'double', None)
    ch4 = IVariable2Dimensional('ch4', ['Timestep', 'Region'], 'double', None)
    n2o = IVariable2Dimensional('n2o', ['Timestep', 'Region'], 'double', None)
    n2ored = IVariable2Dimensional('n2ored', ['Timestep', 'Region'], 'double', None)
    taxpar = IVariable2Dimensional('taxpar', ['Timestep', 'Region'], 'double', None)
    co2red = IVariable2Dimensional('co2red', ['Timestep', 'Region'], 'double', None)
    know = IVariable2Dimensional('know', ['Timestep', 'Region'], 'double', None)
    perm = IVariable2Dimensional('perm', ['Timestep', 'Region'], 'double', None)
    cumaeei = IVariable2Dimensional('cumaeei', ['Timestep', 'Region'], 'double', None)
    ch4red = IVariable2Dimensional('ch4red', ['Timestep', 'Region'], 'double', None)
    ...
    cumglobco2 = IVariable1Dimensional('cumglobco2',['Timestep'],'double',None)
    cumglobch4 = IVariable1Dimensional('cumglobch4',['Timestep'],'double',None)
    cumglobn2o = IVariable1Dimensional('cumglobn2o',['Timestep'],'double', None)
    cumglobsf6 = IVariable1Dimensional('cumglobsf6',['Timestep'],'double',None)
    cumglobso2 = IVariable1Dimensional('cumglobso2',['Timestep'],'double',None)
    ...
    forestemm = IParameter2Dimensional('forestemm', ['Timestep', 'Region'], 'double', None)
    aeei = IParameter2Dimensional('aeei', ['Timestep', 'Region'], 'double', None)
    acei = IParameter2Dimensional('acei', ['Timestep', 'Region'], 'double', None)
    ch4em = IParameter2Dimensional('ch4em', ['Timestep', 'Region'], 'double', None)
    n2oem = IParameter2Dimensional('n2oem', ['Timestep', 'Region'], 'double', None)
    currtax = IParameter2Dimensional('currtax', ['Timestep', 'Region'], 'double', None)
    currtaxch4 = IParameter2Dimensional('currtaxch4', ['Timestep', 'Region'], 'double', None)
    currtaxn2o = IParameter2Dimensional('currtaxn2o', ['Timestep', 'Region'], 'double', None)
    pgrowth = IParameter2Dimensional('pgrowth', ['Timestep', 'Region'], 'double', None)
    ypcgrowth = IParameter2Dimensional('ypcgrowth', ['Timestep', 'Region'], 'double', None)
    ...
    options = [mitigationcost,ch4cost,ch4costindollar,n2ocost,ryg,energint,emissint,emission,emissionwithforestry,
               so2WithSeeiAndScei, so2,sf6,reei,rcei,energuse,seei,scei,ch4,n2o,n2ored,taxpar,co2red,know,perm,
               cumaeei, ch4red,minint, globknow,mco2,globch4,globn2o,globsf6, globso2, cumglobco2,cumglobch4,
               cumglobn2o, cumglobsf6,cumglobso2,taxmp,sf60,GDP90,pop90,ch4par1,ch4par2, n2opar1, n2opar2,gdp0,
               emissint0,so20,forestemm, aeei, acei,ch4em, n2oem,currtax, currtaxch4,currtaxn2o, pgrowth,
               ypcgrowth,income,population,so2pop,so2inc,so2carb,sf6gdp,sf6ypc,knowpar,knowgpar, gwpch4, gwpn2o,
               TaxConstant, TaxEmInt,TaxThreshold,TaxDepreciation, MaxCostFall,ch4add,n2oadd,sf6add]
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.sf6[t, r] = ((s.sf60[r] + s.sf6gdp * (s.income[t, r] - s.GDP90[r]) + s.sf6ypc *
                            ...
                            (t <= Timestep.FromSimulationYear(60) and 1 + ((t - clock.first) - 40.0) / 40.0 or 1.0 +
                            (60.0 - 40.0) / 40.0) * (t > Timestep.FromSimulationYear(60) and math.pow(0.99,
                            (t - clock.first) - 60.0) or 1.0))
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.co2red[t,r] = (s.currtax[t,r] * s.emission[t,r] * s.know[t-1,r] * s.globknow[t-1] /
                                 2 / s.taxpar[t,r] / s.income[t,r] / 1000)
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.ch4red[t,r] = (s.currtaxch4[t,r] * s.ch4em[t,r] / 2 /s.ch4par1[r] /s.ch4par2[r] /
                                 s.ch4par2[r] /s.income[t,r] /1000)
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.n2ored[t,r] = (s.gwpn2o *s.currtaxn2o[t,r] * s.n2oem[t,r] / 2 /s.n2opar1[r] /
                                 s.n2opar2[r] /s.n2opar2[r] /s.income[t,r] /1000)
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                if (t > Timestep.FromYear(2000)):
                    s.cumaeei[t,r] = (s.cumaeei[t - 1,r] *
                                      (1.0 - 0.01 * s.aeei[t,r] - s.reei[t,r] + s.seei[t - 1,r] - s.seei[t, r]))
                else:
                    s.cumaeei[t, r] = (1.0)
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.mitigationcost[
                    t,r] = ((s.taxmp[r] *s.ryg[t,r] +s.n2ocost[t,r]) * s.income[t,r])
            ...
            s.mco2[t] = (globco2)
            s.globch4[t] = (max(0.0, globch4 + ((t - clock.first) > 50 and s.ch4add * ((t - clock.first) - 50) or 0.0)))
            s.globn2o[t] = (max(0.0, globn2o + ((t - clock.first) > 50 and s.n2oadd * ((t - clock.first) - 50) or 0)))
            s.globsf6[t] = (max(0.0, globsf6 + ((t - clock.first) > 50 and s.sf6add * ((t - clock.first) - 50) or 0.0)))
            s.globso2[t] = (globso2)
