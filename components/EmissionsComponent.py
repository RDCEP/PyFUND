...
# 2013-11-05 21:16:12.206588. Think long and hard before
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.sf6[t, r] = ((s.sf60[r] + s.sf6gdp * (s.income[t, r] - s.GDP90[r]) + s.sf6ypc * (s.income[t - 1, r] / s.population[t - 1, r] - s.GDP90[r] / s.pop90[r])) *
                               (t <= Timestep.FromSimulationYear(60) and 1 + (t - 40.0) / 40.0 or 1.0 + (60.0 - 40.0) / 40.0) * (t > Timestep.FromSimulationYear(60) and math.pow(0.99, t - 60.0) or 1.0))
