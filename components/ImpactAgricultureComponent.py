...
# 2013-05-31 13:51:01.712314. Think long and hard before
...
class IImpactAgricultureState(Parameters):
    ...
    options = [gdp90, income, pop90, population, agrish, agrish0, agrate,
               aglevel, agco2, agcost, agrbm, agtime, aglparl, aglparq, agcbm, temp, acco2]
