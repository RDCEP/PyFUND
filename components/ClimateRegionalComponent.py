...
# 2013-05-31 17:48:36.414092. Think long and hard before
...
class IClimateRegionalState(Parameters):
    ...
    scentemp = IParameter2Dimensional('scentemp', [
                                      'Timestep', 'Region'], 'Double', None)
    temp = IVariable2Dimensional('temp', [
                                 'Timestep', 'Region'], 'Double', None)
    regtmp = IVariable2Dimensional('regtmp', [
                                   'Timestep', 'Region'], 'Double', None)
    regstmp = IVariable2Dimensional('regstmp', [
                                    'Timestep', 'Region'], 'Double', None)
