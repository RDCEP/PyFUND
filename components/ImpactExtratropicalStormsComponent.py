...
# 2013-05-31 13:51:05.718488. Think long and hard before
...
class IImpactExtratropicalStormsState(Parameters):
    ...
    options = [
        extratropicalstormsdam, extratropicalstormsdead, extratropicalstormsbasedam,
        extratropicalstormspar, extratropicalstormsbasedead, gdp90, pop90, population, income, acco2]
