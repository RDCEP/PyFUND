...
# 2013-11-05 21:16:21.650294. Think long and hard before
...
class ImpactExtratropicalStormsComponent(Behaviors):
    ...
    def run(self, state, clock, dimensions):
        ...
        for r in dimensions.GetValuesOfRegion():
            ...
            s.extratropicalstormsdam[t, r] = (s.extratropicalstormsbasedam[r] * s.income[t, r] * math.pow(
                ypc / ypc90, s.extratropicalstormsdamel) * (math.pow(1.0 + (s.extratropicalstormspar[r] * (s.acco2[t] / s.co2pre)), s.extratropicalstormsnl) - 1.0))
