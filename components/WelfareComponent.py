...
# 2013-11-05 21:16:28.784103. Think long and hard before
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            if (t >= s.starttimestep):
                ...
                s.cummulativewelfare[t] = (s.cummulativewelfare[
                                           t - 1] + (U(perCapitaConsumption) * s.population[t] * DF(t)))
            ...
            if (t >= s.starttimestep):
                ...
                for r in dimensions.GetValuesOfRegion():
                    ...
                    perCapitaConsumption = (
                        s.consumption[t, r] / s.population[t, r])

                    if (perCapitaConsumption <= 0.0):
                        perCapitaConsumption = (1.0)

                    w = (
                        w + (s.welfareweight[t, r] * U(perCapitaConsumption) * s.population[t, r] * DF(t)))
        ...
        if (clock.IsFirstTimestep):
            ...
            if (t >= s.starttimestep):
                ...
                for r in dimensions.GetValuesOfRegion():
                    ...
                    w = (
                        w + (U(perCapitaConsumption) * s.population[t, r] * DF(t)))
