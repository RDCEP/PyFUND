...
# 2013-05-31 13:51:13.718019. Think long and hard before
...
class IGlobalWelfareState(Parameters):
    ...
    options = [population, consumption, cummulativewelfare, marginalwelfare]
...
class IUtilitarianWelfareState(Parameters):
    ...
    options = [population, consumption, welfareweight,
               cummulativewelfare, marginalwelfare]
...
class IRegionalWelfareState(Parameters):
    ...
    options = [population, consumption,
               cummulativewelfare, marginalwelfare, totalwelfare]
