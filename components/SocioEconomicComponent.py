...
# 2013-05-31 13:51:12.176060. Think long and hard before
...
class ISocioEconomicState(Parameters):
    income = IVariable2Dimensional('income', [
                                   'Timestep', 'Region'], 'double', None)
    consumption = IVariable2Dimensional('consumption', [
                                        'Timestep', 'Region'], 'double', None)
    ypc = IVariable2Dimensional('ypc', ['Timestep', 'Region'], 'double', None)
    ygrowth = IVariable2Dimensional('ygrowth', [
                                    'Timestep', 'Region'], 'double', None)
    plus = IVariable2Dimensional('plus', [
                                 'Timestep', 'Region'], 'double', None)
    urbpop = IVariable2Dimensional('urbpop', [
                                   'Timestep', 'Region'], 'double', None)
    popdens = IVariable2Dimensional('popdens', [
                                    'Timestep', 'Region'], 'double', None)
    ...
    ypcgrowth = IParameter2Dimensional('ypcgrowth', [
                                       'Timestep', 'Region'], 'double', None)
    eloss = IParameter2Dimensional('eloss', [
                                   'Timestep', 'Region'], 'double', None)
    sloss = IParameter2Dimensional('sloss', [
                                   'Timestep', 'Region'], 'double', None)
    ...
    options = [
        income, consumption, ypc, ygrowth, plus, urbpop, popdens, globalconsumption, globalypc, globalincome, ypc90, pgrowth,
        ypcgrowth, eloss, sloss, mitigationcost, area, globalpopulation, population, populationin1, plus90, gdp90, pop90, urbcorr, gdp0]
...
class SocioEconomicComponent(Behaviors):
    ...
    def run(self, state, clock):
        ...
        if (clock.IsFirstclock):
            ...
            for r in dimensions.GetValuesOfRegion():
                oldincome = (s.income[t - 1, r] - ((t >= clock.FromSimulationYear(
