...
# 2013-11-05 21:16:11.015593. Think long and hard before
...
class IClimateForcingState(Parameters):
    ...
    acch4 = IParameter1Dimensional(
        'acch4', ['Timestep'], 'double', 'Atmospheric CH4 concentration')
    acn2o = IParameter1Dimensional(
        'acn2o', ['Timestep'], 'double', 'Atmospheric N2O concentration')
    acsf6 = IParameter1Dimensional(
        'acsf6', ['Timestep'], 'double', 'Atmospheric SF6 concentrations')
    acso2 = IParameter1Dimensional(
        'acso2', ['Timestep'], 'double', 'Atmospheric SO2 concentration')
    rfCO2 = IVariable1Dimensional(
        'rfCO2', ['Timestep'], 'double', 'Radiative forcing from CO2')
    rfCH4 = IVariable1Dimensional(
        'rfCH4', ['Timestep'], 'double', 'Radiative forcing from CH4')
    rfN2O = IVariable1Dimensional(
        'rfN2O', ['Timestep'], 'double', 'Radiative forcing from N2O')
    rfSF6 = IVariable1Dimensional(
        'rfSF6', ['Timestep'], 'double', 'Radiative forcing from N2O')
    rfSO2 = IVariable1Dimensional(
        'rfSO2', ['Timestep'], 'double', 'Radiative forcing from SO2')
    radforc = IVariable1Dimensional(
        'radforc', ['Timestep'], 'double', 'Radiative forcing')
    rfEMF22 = IVariable1Dimensional(
        'rfEMF22', ['Timestep'], 'double', 'EMF22 radiative forcing')
...
class ClimateForcingComponent(Behaviors):
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            s.rfCH4[t] = (0.036 * (1.0 + s.ch4ind) * (math.sqrt(s.acch4[t])
                          - math.sqrt(s.ch4pre)) - Interact(s.acch4[t], s.n2opre) + ch4n2o)
