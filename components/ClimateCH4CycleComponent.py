...
class IClimateCH4CycleState(Parameters):
    globch4 = IParameter1Dimensional('globch4',['Timestep'],'double','Global CH4 emissions in Mt of CH4')
    acch4 = IVariable1Dimensional('acch4',['Timestep'],'double','Atmospheric CH4 concentration')
