...
class IClimateCO2CycleState(Parameters):
    mco2 = IParameter1Dimensional('mco2',['Timestep'],'double','Anthropogenic CO2 emissions in Mt of C')
    TerrestrialCO2 = IVariable1Dimensional('TerrestrialCO2',['Timestep'],'double','Terrestrial biosphere CO2 emissions in Mt of C')
    globc = IVariable1Dimensional('globc',['Timestep'],'double','Net CO2 emissions in Mt of C')
    cbox1 = IVariable1Dimensional('cbox1',['Timestep'],'double','Carbon box 1')
    cbox2 = IVariable1Dimensional('cbox2',['Timestep'],'double','Carbon box 2')
    cbox3 = IVariable1Dimensional('cbox3',['Timestep'],'double','Carbon box 3')
    cbox4 = IVariable1Dimensional('cbox4',['Timestep'],'double','Carbon box 4')
    cbox5 = IVariable1Dimensional('cbox5',['Timestep'],'double','Carbon box 5')
    acco2 = IVariable1Dimensional('acco2',['Timestep'],'double','Atmospheric CO2 concentration')
    TerrCO2Stock = IVariable1Dimensional('TerrCO2Stock',['Timestep'],'double','Stock of CO2 in the terrestrial biosphere')
    ...
    co2frac1 = ScalarVariable('co2frac1','double', 'Fraction of carbon emission in box 1')
    co2frac2 = ScalarVariable('co2frac2','double', 'Fraction of carbon emission in box 2')
    co2frac3 = ScalarVariable('co2frac3','double', 'Fraction of carbon emission in box 3')
    co2frac4 = ScalarVariable('co2frac4','double', 'Fraction of carbon emission in box 4')
    co2frac5 = ScalarVariable('co2frac5','double', 'Fraction of carbon emission in box 5')
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            if (t > Timestep.FromYear(2010)):
                ...
                s.TerrestrialCO2[t] = ((s.temp[t-1] - s.tempIn2010) * s.TerrCO2Sens * s.TerrCO2Stock[t-1] /
                                       s.TerrCO2Stock0)

            else:
                s.TerrestrialCO2[t] = (0)

            s.TerrCO2Stock[t] = (max(s.TerrCO2Stock[t - 1] - s.TerrestrialCO2[t], 0.0))
