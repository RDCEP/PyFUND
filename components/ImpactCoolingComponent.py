...
# 2013-10-25 13:48:00.968124. Think long and hard before
    ...
    def run(self, state, clock, dimensions):
        ...
        if (clock.IsFirstTimestep):
            ...
            for r in dimensions.GetValuesOfRegion():
                ...
                s.cooling[t, r] = (s.cebm[r] * s.cumaeei[t, r] * s.gdp90[r] * math.pow(
                    s.temp[t, r] / 1.0, s.cenl) * math.pow(ypc / ypc90, s.ceel) * s.population[t, r] / s.pop90[r])
